...
class VistaEliminarProceso(QWidget):
    def __init__(self):
        ...
        # 2. ComboBox para seleccionar el proceso a borrar
        ...
        # 3. Botón de eliminación (Rojo peligro)
        ...
        # Cargar los procesos apenas se abre la pantalla
        self.cargar_combo_box()
        
    def cargar_combo_box(self):
        """Busca todos los procesos y los carga en el ComboBox"""
        try:
            self.combo_proceso.clear()
            
            # Reutilizamos el método que creamos en el paso anterior
            ...
            if registros:
                ...
                self.boton_eliminar.setEnabled(False) # Desactiva el botón si no hay nada
